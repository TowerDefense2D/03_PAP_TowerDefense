...
public class TD2D_Tiles : EditorWindow
{
	...
	// Conteúdo visual para as partes do editor
	...
	/// </summary>
	/// <param name="scene">Cena</param>
	/// <param name="openSceneMode">Modo de cena aberta</param>
	...
	private void UpdateStuff()
	{
		...
		// Define rótulos para os prefabs. O rótulo será usado na janela do selecionador
		string[] prefabs;
	...
	{
		pickerState = state;
		// Cria um ID de controle do selecionador de janela
		currentPickerWindow = EditorGUIUtility.GetControlID(FocusType.Passive);
		// Use o ID que você acabou de criar
